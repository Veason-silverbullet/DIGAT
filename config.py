...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--dev_model_path', type=str, default='best_model/MSA-DIGAT/#1/MSA-DIGAT', help='Dev model path')
        parser.add_argument('--test_model_path', type=str, default='best_model/MSA-DIGAT/#1/MSA-DIGAT', help='Test model path')
